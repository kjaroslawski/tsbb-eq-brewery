...
package eu.qamar.brewery.services;

import eu.qamar.brewery.domain.BeerInventory;
import eu.qamar.brewery.domain.BeerOrder;
import eu.qamar.brewery.domain.BeerOrderLine;
import eu.qamar.brewery.domain.OrderStatusEnum;
import eu.qamar.brewery.repositories.BeerInventoryRepository;
import eu.qamar.brewery.repositories.BeerOrderRepository;
...
public class BeerOrderAllocationService {
    ...
    public BeerOrderAllocationService(BeerOrderRepository beerOrderRepository,
    ...
    private void allocateBeerOrderLine(BeerOrderLine beerOrderLine) {
        ...
        beerInventoryList.forEach(beerInventory -> {
            ...
            int allocatedQty = (beerOrderLine.getQuantityAllocated() ==
                                null) ? 0 : beerOrderLine.getQuantityAllocated();
